...
<br>
<div class="container">
	<center><h2><i class="fa fa-truck"></i> <?php echo $head; ?></h2></center>
	<hr>
	...
	?>
		 <tr>
		 	...
		 	<td><center>
		 		...
		 		<a href="#" data-toggle="modal" data-target="#hpsModal" data-padid="<?php echo $id ?>" class="btn btn-danger hapus"><i class="fa fa-trash"></i> Hapus</a>
		 	</center></td>
		 </tr>
	<?php
			$no++;
...
<!-- MODAL INSERT DATA -->
<?php echo form_open('entry/Pemakai/add'); ?>
    ...
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color:#84B899;">
          ...
          <h4 class="modal-title" style="color: white;"><center><i class="fa fa-truck"></i> <b>Tambah Pemakai</b></center></h4>
        </div>
        <div class="modal-body">
          <div class="container">
            <label>Masukan Nama Pemakai</label>
...
<!-- MODAL EDIT ADMIN -->
<?php echo form_open('entry/Pemakai/update'); ?>
  <div class="modal fade" id="ubahModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color:#84B899;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="color:white;"><center><b><i class="fa fa-edit"></i> Ubah Pemakai</b></center></h4>
        </div>
        <div class="modal-body">
         	<div class="container">
            <input type="hidden" name="id_pakai" id="id">
            <label>Nama Pemakai</label>
            <input type="text" name="pemakai" class="form-control" id="nama" placeholder="Pemakai">
          </div>	
        </div>
        <div class="modal-footer">
...
<!-- MODAL HAPUS ADMIN -->
<?php echo form_open('entry/Pemakai/delete'); ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color:#ff6666;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="color:white;"><center><b><i class="fa fa-trash"></i> Hapus Pemakai</b></center></h4>
        </div>
        <div class="modal-body">
          <center>
