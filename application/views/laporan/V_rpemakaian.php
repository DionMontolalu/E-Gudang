...
<?php echo form_open('laporan/Rmasuk') ?>
  <div class="row">
	<div class="col-md-3">
	  ...
	  <select class="form-control" name="pemakai_id" id="pemakai">
		<option value="">--pilih pemakai--</option>
        <?php
        	foreach ($pemakai as $pmk) {
            	echo "<option value='$pmk[id_pemakai]'>$pmk[nama_pemakai]</option>";
            }
        ?>
	  </select>
	</div>
...
$(function(){
  $.ajaxSetup({
    type:"POST",
    url: "<?php echo base_url('index.php/laporan/Rpemakain/ambil_data') ?>",
    cache: false,
  });
